...
const BentoCard = ({ src, title, description }: IFeature) => {
  return (
    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-10 md:px-20">
        ...
        <div className="grid w-full h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          <div className="bento-tilt_1 col-span-2 row-span-2 md:col-span-1">
            <BentoCard
          ...
          <div className="bento-tilt_1 col-span-1 row-span-1">
              <BentoCard
